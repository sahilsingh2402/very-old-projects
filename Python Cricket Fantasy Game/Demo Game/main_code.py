...
#To import open window dialogbox
from open import Ui_Dialog as Open   

#To import new window dialog box
from newteam import Ui_Dialog as New     

#To import evaluate window dialog box
from evaluate import Ui_evaluate_team as Eva  

import sqlite3

#Connection to database
fant=sqlite3.connect('cricket_db.db')   
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #Points count and initialization
        ...
        #Allrounders name list
        self.c = []

        #Wicket keepers name list
        self.d = []
        ...
        self.frame.setStyleSheet("background-color: rgb(242, 184, 25);\n"
...
"")
        ...
        self.BAT.setStyleSheet("color: rgb(183, 0, 255);")
        ...
        self.WK.setStyleSheet("color: rgb(183, 0, 255);")
...
"border-color: rgb(255, 255, 255);")
        ...
        self.menuManage_Teams.setStyleSheet("color: rgb(183, 0, 255);")
        self.menuManage_Teams.setStyleSheet("background-color: rgb(232, 232, 232);")
        self.menuManage_Teams.setStyleSheet("selection-background-color: rgb(183, 0, 255);\n""\n""")
    ...
    def namechange(self):
        ...
        if len(teamname) == 0:
            ...
            msg.setText("You cannot leave this field blank!!!")
            msg.setWindowTitle("Invalid Team Name")
            msg.exec_()
            return 0
